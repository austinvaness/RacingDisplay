    ...
    public class RacingCommands
    {
        ...
        public RacingCommands(Track race)
        {
            ...
            if (RacingConstants.IsServer)
            {
                ...
                Add(new ACmdClear(), new ACmdFinish(), new ACmdGrant(), new ACmdKick(), new ACmdLaps(), new ACmdLooped(), new ACmdMode(), new ACmdStrictStart(), new ACmdTimers(), new ACmdNode(), new ACmdTrack());
                BuildHelpText();
