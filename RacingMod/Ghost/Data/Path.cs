...
namespace avaness.RacingMod.Ghost.Data
{
    ...
    public partial class Path
    {
        ...
        public static Path ConvertToPath(string base64)
        {
            try
            {
            ...
            {
                MyLog.Default.WriteLineAndConsole("[Racing Display] Error decompressing path data: " + e.ToString());
                return null;
            }
        }
        ...
        public string ConvertToBase64()
        {
            try
            {
                byte[] uncompressed = MyAPIGateway.Utilities.SerializeToBinary(this);
                byte[] compressed = MyCompression.Compress(uncompressed);
                return Convert.ToBase64String(compressed);
            }
            catch (Exception e)
            {
                MyLog.Default.WriteLineAndConsole("[Racing Display] Error compressing path data: " + e.ToString());
                return null;
            }
        }
    }
